...
exports.unescapeTable = exports.escapeTable = void 0;
...
const symbols = {
    ...
    prime: 8242, Prime: 8243, oline: 8254, frasl: 8260, weierp: 8472,
    image: 8465, real: 8476, trade: 8482, alefsym: 8501, larr: 8592,
...
const unescapeTable = { ...latin1, ...symbols, ...markup };
exports.unescapeTable = unescapeTable;
const escapeTable = {};
exports.escapeTable = escapeTable;
Object.keys(unescapeTable).forEach(key => { escapeTable[unescapeTable[key]] = key; });
